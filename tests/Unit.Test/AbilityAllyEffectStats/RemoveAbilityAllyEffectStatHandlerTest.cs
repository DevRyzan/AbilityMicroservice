...
public class RemoveAbilityAllyEffectStatHandlerTest
{
    ...
    public RemoveAbilityAllyEffectStatHandlerTest()
    {
    ...
    public async Task AbilityActivationType_RemoveHandler_ValidRequest_ReturnsResponse(string id)
    {
        ...
        var handler = new RemoveAbilityAllyEffectStatHandler(_abilityAllyEffectStatServiceMock.Object, _abilityAllyEffectStatBusinessRulesMock.Object, _mapperMock.Object);

        var request = new RemoveAbilityAllyEffectStatRequest
        {
            RemoveAbilityAllyEffectStatDto = new RemoveAbilityAllyEffectStatDto
            {
                Id = id
            }
        };
        ...
        var expectedResponse = new RemoveAbilityAllyEffectStatResponse
        {
            Id = id
        };

        _mapperMock.Setup(m => m.Map<AbilityAllyEffectStat>(request.RemoveAbilityAllyEffectStatDto))
                   .Returns(abilityAllyEffectStat);

        _abilityAllyEffectStatServiceMock.Setup(m => m.GetById(id))
                                        .ReturnsAsync(abilityAllyEffectStat);

        _abilityAllyEffectStatServiceMock.Setup(m => m.Remove(abilityAllyEffectStat))
                                        .ReturnsAsync(abilityAllyEffectStat);

        _mapperMock.Setup(m => m.Map<RemoveAbilityAllyEffectStatResponse>(abilityAllyEffectStat))
        ...
        _abilityAllyEffectStatServiceMock.Verify(m => m.Remove(abilityAllyEffectStat), Times.Once);
