...
public class DeleteAbilityEffectDisableTypeHandlerTest
{
    ...
    public DeleteAbilityEffectDisableTypeHandlerTest()
    {
    ...
    public async Task AbilityEffect_DeleteHandler_ValidRequest_ReturnsResponse(string id)
    {
        ...
        var handler = new DeleteAbilityEffectDisableTypeHandler(_abilityEffectDisableTypeServiceMock.Object, businessRuleMock.Object, _mapperMock.Object);

        var request = new DeleteAbilityEffectDisableTypeRequest
        {
            DeleteAbilityEffectDisableTypeDto = new DeleteAbilityEffectDisableTypeDto
            {
                Id = id
            }
        };
        ...
        var expectedResponse = new DeleteAbilityEffectDisableTypeResponse
        {
            Id = id,
        ...
        _mapperMock.Setup(m => m.Map<AbilityEffectDisableType>(request.DeleteAbilityEffectDisableTypeDto))
        ...
        _abilityEffectDisableTypeServiceMock.Setup(m => m.Delete(abilityEffectDisableType))
                                        .ReturnsAsync(abilityEffectDisableType);

        _mapperMock.Setup(m => m.Map<DeleteAbilityEffectDisableTypeResponse>(abilityEffectDisableType))
        ...
        _abilityEffectDisableTypeServiceMock.Verify(m => m.Delete(abilityEffectDisableType), Times.Once);
    }
}
