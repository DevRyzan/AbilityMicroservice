...
public class UndoDeleteAbilityEffectDisableTypeHandlerTest
{
    ...
    public UndoDeleteAbilityEffectDisableTypeHandlerTest()
    {
    ...
    public async Task AbilityEffectDisableType_UndoDeleteHandler_ValidRequest_ReturnsResponse(string id)
    {
        var businessRuleMock = new Mock<AbilityEffectDisableTypeBusinessRules>(_abilityEffectDisableTypeRepositoryMock.Object);

        var handler = new UndoDeleteAbilityEffectDisableTypeHandler(_abilityEffectDisableTypeServiceMock.Object, businessRuleMock.Object, _mapperMock.Object);

        var request = new UndoDeleteAbilityEffectDisableTypeRequest
        {
            UndoDeleteAbilityEffectDisableTypeDto = new UndoDeleteAbilityEffectDisableTypeDto
            {
                Id = id
            }
        };
        ...
        var expectedResponse = new UndoDeleteAbilityEffectDisableTypeResponse
        {
            Id = id,
        ...
        _mapperMock.Setup(m => m.Map<AbilityEffectDisableType>(request.UndoDeleteAbilityEffectDisableTypeDto))
        ...
        _mapperMock.Setup(m => m.Map<UndoDeleteAbilityEffectDisableTypeResponse>(abilityEffectDisableType))
