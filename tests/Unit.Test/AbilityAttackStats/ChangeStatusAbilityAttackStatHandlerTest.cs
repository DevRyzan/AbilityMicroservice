...
public class ChangeStatusAbilityAttackStatHandlerTest
{
    ...
    public ChangeStatusAbilityAttackStatHandlerTest()
    {
    ...
    public async Task AbilityAttackStat_ChangeStatusHandler_ValidRequest_ReturnsResponse(string id)
    {
        var businessRuleMock = new Mock<AbilityAttackStatBusinessRules>(_abilityAttackStatRepositoryMock.Object);

        var handler = new ChangeStatusAbilityAttackStatHandler(_abilityAttackStatServiceMock.Object, businessRuleMock.Object, _mapperMock.Object);

        var request = new ChangeStatusAbilityAttackStatRequest
        {
            ChangeStatusAbilityAttackStatDto = new ChangeStatusAbilityAttackStatDto
            {
                Id = id
            }
        };
        ...
        var expectedResponse = new ChangeStatusAbilityAttackStatResponse
        {
            Id = id,
        ...
        _mapperMock.Setup(m => m.Map<AbilityAttackStat>(request.ChangeStatusAbilityAttackStatDto))
        ...
        _mapperMock.Setup(m => m.Map<ChangeStatusAbilityAttackStatResponse>(abilityAttackStat))
