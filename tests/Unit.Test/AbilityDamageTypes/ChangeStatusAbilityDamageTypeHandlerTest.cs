...
public class ChangeStatusAbilityDamageTypeHandlerTest
{
    ...
    public ChangeStatusAbilityDamageTypeHandlerTest()
    {
    ...
    public async Task AbilityDamageType_ChangeStatusHandler_ValidRequest_ReturnsResponse(string id)
    {
        var businessRuleMock = new Mock<AbilityDamageTypeBusinessRules>(_abilityDamageTypeRepositoryMock.Object);

        var handler = new ChangeStatusAbilityDamageTypeHandler(_abilityDamageTypeServiceMock.Object, businessRuleMock.Object, _mapperMock.Object);

        var request = new ChangeStatusAbilityDamageTypeRequest
        {
            ChangeStatusAbilityDamageTypeDto = new ChangeStatusAbilityDamageTypeDto
            {
                Id = id
            }
        };
        ...
        var expectedResponse = new ChangeStatusAbilityDamageTypeResponse
        {
            Id = id,
        ...
        _mapperMock.Setup(m => m.Map<AbilityDamageType>(request.ChangeStatusAbilityDamageTypeDto))
        ...
        _mapperMock.Setup(m => m.Map<ChangeStatusAbilityDamageTypeResponse>(abilityDamageType))
