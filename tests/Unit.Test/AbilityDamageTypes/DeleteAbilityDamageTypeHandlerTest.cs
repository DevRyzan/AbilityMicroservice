...
public class DeleteAbilityDamageTypeHandlerTest
{
    ...
    public DeleteAbilityDamageTypeHandlerTest()
    {
    ...
    public async Task AbilityDamageType_DeleteHandler_ValidRequest_ReturnsResponse(string id)
    {
        var businessRuleMock = new Mock<AbilityDamageTypeBusinessRules>(_abilityDamageTypeRepositoryMock.Object);

        var handler = new DeleteAbilityDamageTypeHandler(_abilityDamageTypeServiceMock.Object, businessRuleMock.Object, _mapperMock.Object);

        var request = new DeleteAbilityDamageTypeRequest
        {
            DeleteAbilityDamageTypeDto = new DeleteAbilityDamageTypeDto
            {
                Id = id
            }
        };
        ...
        var expectedResponse = new DeleteAbilityDamageTypeResponse
        {
            Id = id,
        ...
        _mapperMock.Setup(m => m.Map<AbilityDamageType>(request.DeleteAbilityDamageTypeDto))
                   .Returns(abilityDamageType);

        _abilityDamageTypeServiceMock.Setup(m => m.GetById(id))
                                        .ReturnsAsync(abilityDamageType);

        _abilityDamageTypeServiceMock.Setup(m => m.Delete(abilityDamageType))
                                        .ReturnsAsync(abilityDamageType);

        _mapperMock.Setup(m => m.Map<DeleteAbilityDamageTypeResponse>(abilityDamageType))
        ...
        _abilityDamageTypeServiceMock.Verify(m => m.Delete(abilityDamageType), Times.Once);
    }
}
